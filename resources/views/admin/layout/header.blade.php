            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ $user_data->profile_picture ? $user_data->profile_picture : $route . 'img/user.jpg' }}" alt="" style="width: 40px; height: 40px;">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{ $user_data->profile_picture ? $user_data->profile_picture : $route . 'img/user.jpg' }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="{{route('home')}}">HSGroup</a>, All Right Reserved. This is  
                        </div>
